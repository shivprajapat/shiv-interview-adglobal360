    ...
    <div className="pt-12 pb-16 relative">
      ...
      <div className="container relative text-center">
        <div className="mb-6 md:mb-7">
          <p className="text-lg md:text-2xl text-white font-normal mb-3 uppercase">
            COMPANY SUCCESS
          </p>
          <h2 className="text-2xl md:text-3xl lg:text-5xl inline-block mx-auto font-normal text-white">
